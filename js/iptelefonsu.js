 ...
 */
window.iptelefonsuHandleDownload = (function ($) {
    "use strict";

    var IptelefonsuRecord = (function ($) {

        IptelefonsuRecord = function (options) {
            var that = this;
        ...
        IptelefonsuRecord.prototype.initClass = function () {
            var that = this;
        ...
        IptelefonsuRecord.prototype.load = function () {
            var that = this;
            ...
            if (!that.is_locked) {
                ...
                var href = $.crm.app_url + "?plugin=iptelefonsu&action=getRecordLink",
                    data = that.params;
        ...
        IptelefonsuRecord.prototype.setState = function (state) {
            var that = this,
                icon_class;
...
var IptelefonsuSettings = (function ($) {

    IptelefonsuSettings = function (options) {
        var that = this;
    ...
    IptelefonsuSettings.prototype.initClass = function () {
        var that = this;
    ...
    IptelefonsuSettings.prototype.initCrmKeyGenerator = function () {
        var that = this,
            $link = that.$wrapper.find('.js-generate'),
            $input = that.$wrapper.find('#iptelefon_crm_iptelefonsu_crm_key');
    ...
    IptelefonsuSettings.prototype.checkApi = function() {
        var that = this,
            $api_status = that.$wrapper.find('.js-api-status'),
            href = "?plugin=iptelefonsu&module=checkApi";
    ...
    IptelefonsuSettings.prototype.initSubmit = function() {
        var that = this,
            $form = that.$form,
        ...
        $form.on('submit', function (e) {
            e.preventDefault();
            var href = "?module=plugins&id=iptelefonsu&action=save",
    ...
    IptelefonsuSettings.prototype.tweakButton = function (is_yellow) {
        var that = this,
            $button = that.$button;
